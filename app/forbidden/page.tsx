...
export default function ForbiddenPage() {
     ...
     const nav = useNavigationStore<any>((state) => state.nav)
          ...
          <main className="flex min-h-screen items-center justify-center bg-gray-50 px-6 font-secondary">
               <div className="w-full max-w-xl rounded-2xl border border-red-100 bg-white p-10 text-center shadow-lg">
                    ...
                    <div className="mt-8 flex justify-center">
                         <button
                              onClick={() => router.replace(`${nav[0]?.url}`)}
                              className="inline-flex items-center gap-2 rounded-lg bg-brand-primary px-6 py-3 text-white transition hover:opacity-90"
                         >
