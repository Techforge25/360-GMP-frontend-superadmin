...
export const getAccountStat = async (dateRange: string) => {
  try {
    const { data } = await api.get(
      `/accountManagement/stats?dateRange=${dateRange}`,
    );
    return data;
  } catch (error: any) {
    toast.error(error?.message);
...
export const getUserProfiles = async (
  ...
  page: number,
  validityChange: string,
) => {
  try {
    const { data } = await api.get(
      `/accountManagement/userProfiles?dateRange=${dateRange}&search=${debounceSearch}&page=${page}&limit=10&type=${validityChange}`,
    );
    return data;
  } catch (error: any) {
    toast.error(error?.message);
...
export const getBusinessProfiles = async (
  ...
  try {
    const { data } = await api.get(
      `/accountManagement/businessProfiles?dateRange=${dateRange}&page=${page}&limit=10&type=${validityChange}&status=${status}&search=${debounceSearch}`,
    );
    return data;
  } catch (error: any) {
    toast.error(error?.message);
...
export const approveBusiness = async (id: ParamValue) => {
  try {
    const { data } = await api.patch(
      `/accountManagement/businessProfile/${id}/approve`,
    );
...
export const rejectBusiness = async ({ id, note }: RejectBusinessPayload) => {
  try {
    const { data } = await api.patch(
