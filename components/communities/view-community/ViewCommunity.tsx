...
export default function ViewCommunity() {
  ...
  return (
    <div className="">
      ...
      <CommunityCards companyName={communityData?.creator?.companyName} ownerName={communityData?.creator?.ownerName} logo={communityData?.creator?.logo} createdAt={communityData?.creator?.createdAt} description={communityData?.description} isPending={isPending} purpose={communityData?.purpose} rules={communityData?.rules} />
